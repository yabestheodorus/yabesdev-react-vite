  ...
  return (
    ...
    >
      <p className="text-gray-600 max-w-5xl text-center mx-auto mt-4 text-3xl leading-relaxed font-geistmono">
        ...
        <span className="relative inline-block">
          ...
          <span className="relative z-10 bg-amber-500/10 text-amber-700 px-1.5 py-0.5 rounded-sm">
            ...
            <svg
              ...
              viewBox="0 0 24 24"
            >
              <path d="M14.828 14.828a2 2 0 01-2.828 0l-4-4a2 2 112.828-2.828L12 10.172l2.828-2.828a2 2 012.828 2.828l-4 4z" />
            </svg>
          </span>
          &nbsp;web applications
        </span>
        ...
        {" and "}
        <span className="font-semibold text-slate-800">maintainable code</span>
        {" from day one."}
      </p>
    </motion.span>
  );
